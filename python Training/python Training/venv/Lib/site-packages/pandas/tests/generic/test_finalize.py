...
_all_methods = [
    ...
    (
        pd.DataFrame,
        ({"A": [1], "B": [1]},),
        operator.methodcaller("pivot_table", columns="A", aggfunc=["mean", "add"]),
    ),
    ...
    pytest.param(
        (pd.DataFrame, frame_data, operator.methodcaller("add")),
        marks=not_implemented_mark,
    ),
    pytest.param(
