...
def test_resample_closed_right():
    ...
    result = ser.resample("T", closed="right", label="right").add()
    expected = Series(
        [0, 3, 7, 11, 15, 9],
